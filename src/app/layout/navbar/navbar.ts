...
@Component({
  ...
  <div class="max-w-screen-lg flex flex-wrap items-center justify-between mx-auto p-4 border-y border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 ">
    ...
    <h1 class="ml-1 text-sm lg:text-base font-semibold dark:text-white"><a routerLink="/" class="hover:underline">Taipei ACM SIGGRAPH</a></h1>
      ...
      <ul
        ...
        <li class="relative parent">
          <div class="flex justify-between place-items-center">
            ...
            <svg *ngIf=link.childrens.length (click)="clickTri($index)" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current lg:hidden pt-1 dark:text-white" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg>
        </div>
